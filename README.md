...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-9918d5f2-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-9918d5f2-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-9918d5f2-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-9918d5f2-light.svg">
    <img src="./assets/hero/agent-console-9918d5f2-dark.svg" alt="Rendika Adji Putra - Full-Stack Dev | Laravel • Flutter • Python" width="100%">
  </picture>
</p>
...
`PHP` · `Laravel` · `Flutter` · `Dart` · `MySQL` · `PostgreSQL` · `Tailwind CSS` · `Alpine.js` · `Python` · `C++` · `AI Agents` · `Automation`
